...
export const ViewPaidPatientToAdmin = () => {
    // State Management
    ...
    const fetchAssignedPatients = async () => {
        try {
            ...
            const response = await axios.get(`/api/user/fetch-assigned-patient-data?page=${currentPage}&recordsPerPage=${recordsPerPage}&paid=true`, {
                headers: {
    ...
    return (
        <div>
            ...
            <div className="container mt-5">
                <h2 className="text-center mb-4">View Paid Patients</h2>
