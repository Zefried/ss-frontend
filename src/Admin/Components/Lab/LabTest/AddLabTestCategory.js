...
export const AddLabTestCategory = () => {
    ...
    function handleSubmit(e){
        ...
        axios.get('sanctum/csrf-cookie').then(response => {
            axios.post('api/admin/lab-test/add-test-category', testCategory, {
            headers: {
        ...
        <div className="container mt-5">
            <div className="row justify-content-center">
                ...
                <div className="card shadow-lg p-4">
                    <h2 className="card-title text-center mb-4">Add Test Category</h2>
                    ...
                    <div className="form-group mb-3">
                        ...
                        id="name"
                        value={testCategory.test_category}
